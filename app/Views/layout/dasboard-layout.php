    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= route_to('user.home'); ?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Admin_Ci4</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Wutcharawit</a>
                    </div>
                </div>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2014-2021 <a href="<?= base_url(); ?>">Wutcharawit</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
